...
const DeleteConfirmModal = ({ row, onConfirm, onCancel }) => {
    if (!row) return null;
    ...
    return (
        <div
            ...
            onClick={onCancel}
        >
            {/* w-[400px] → w-full max-w-[400px] để không tràn trên mobile */}
            <div
                className="bg-white rounded-[16px] w-full max-w-[400px] p-6 flex flex-col gap-4 shadow-xl"
            ...
            >
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[14px] text-[#6b7280] leading-[22px]">
                        Remove this administrator from the platform and revoke their access.
                    </p>
                </div>
