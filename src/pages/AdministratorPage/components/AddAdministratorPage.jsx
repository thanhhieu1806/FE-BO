...
const AddAdministratorPage = () => {
    ...
    return (
        <div className="w-full bg-[#f8f9fb] p-4 sm:p-6">
            {/* Breadcrumb */}
            <nav className="flex items-center gap-1.5 text-[16px] leading-[24px] mb-4">
                ...
                <span className="font-bold text-[#0057ff]">Add administrators</span>
            </nav>

            {/* Page header — wrap trên mobile */}
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
                <div className="min-w-0">
                    <h1 className="text-[20px] font-bold text-[#111827] leading-[28px]">Add administrators</h1>
                    <p className="text-[13px] text-[#6b7280] mt-0.5">
                        Invite a new platform administrator and assign their access role.
                    </p>
                </div>
