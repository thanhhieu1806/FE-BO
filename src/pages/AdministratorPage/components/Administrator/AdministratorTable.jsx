...
const STATUS_CONFIG = {
    Active: {
        ...
        style: { backgroundColor: '#f0fdf4', borderRadius: '999px', padding: '4px 8px', width: '58px', height: '28px' },
    },
    Inactive: {
        label: 'Inactive',
...
const ROLE_DOT = {
    ...
    'Admin': 'bg-blue-500',
    'Supervisor': 'bg-gray-400',
};

const COLUMNS = [
    { id: 'id', label: 'ID', width: 'w-[110px]' },
    { id: 'name', label: 'Name', width: 'w-[180px]' },
    { id: 'email', label: 'Email', width: 'w-[220px]' },
    { id: 'role', label: 'Role', width: 'w-[150px]' },
    { id: 'createdDate', label: 'Create date', width: 'w-[180px]' },
...
const RoleCell = ({ value }) => (
    <span className="flex items-center gap-2">
        <span className={`w-[7px] h-[7px] rounded-full shrink-0 ${ROLE_DOT[value] ?? 'bg-gray-400'}`} />
        <span className="text-[13px] text-[#1f2937]">{value}</span>
    </span>
);

/* Status badge — 58x28, padding 4px 8px, border-radius 999px theo Figma */
...
/* Action button — 24x24, padding 2px, border-radius 4px theo Figma */
                        ...
                        rows.map((row, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className={tdClass}><RoleCell value={row.role} /></td>
                                    <td className={tdClass}>{row.createdDate}</td>
