...
const PageBtn = ({ active, disabled, onClick, children }) => (
    <button
        onClick={onClick}
        disabled={disabled}
        className={`flex items-center justify-center w-8 h-8 text-[13px] rounded-md border transition-colors
            ${active
...
const AdministratorPagination = ({ page, pageSize, total, onPageChange, onPageSizeChange }) => {
    ...
    return (
        // Stack dọc trên mobile, ngang từ sm
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 flex-wrap">
                ...
                {/* Rút gọn text để tránh vỡ trên màn nhỏ */}
...
export default AdministratorPagination;