...
import { MethodBadge, ResponseCodeBadge } from '../ApiLog/ApiLogTable';
...
const InfoRow = ({ label, children }) => (
    <div className="flex items-start gap-2">
        <span className="text-[13px] text-[#6b7280] w-[130px] shrink-0 leading-[20px]">{label}</span>
...
const DetailApiLogPage = () => {
    ...
    const handleBack = () => navigate(ROUTES.API_LOGS);
        ...
        <div className="w-full bg-[#f8f9fb] p-4 sm:p-6 min-h-full">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
                <div className="min-w-0">
                    ...
                    <h1 className="text-[20px] font-bold text-[#111827] leading-[28px]">API log details</h1>
...
export default DetailApiLogPage;
