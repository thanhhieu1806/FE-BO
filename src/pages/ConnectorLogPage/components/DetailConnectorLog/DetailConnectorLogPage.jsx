...
import { MethodBadge, ResponseCodeBadge } from '../ConnectorLog/ConnectorLogTable';

/* FILE REBUILT — see full content below */
...
const InfoRow = ({ label, children }) => (
    <div className="flex items-start gap-2">
        <span className="text-[13px] text-[#6b7280] w-[140px] shrink-0 leading-[20px]">{label}</span>
...
const MOCK_DETAIL = {
    logId: '23142154',
    connectorName: 'MOBILE-ID TECH',
    method: 'GET',
    function: '/api/v1/refresh/cache',
    ipAddress: '10.0.12.45',
    url: 'http://10.1.0.24:20080/api/v1/refresh/cache',
    requestBillcode: 'null',
    responseCode: '1001',
    responseMessage: 'User not found',
    time: '01/01/2024 14:49:00',
...
const DetailConnectorLogPage = () => {
    ...
    const detail = {
        ...MOCK_DETAIL,
        logId: rowData.logId || rowData.id || MOCK_DETAIL.logId,
        connectorName: rowData.name || rowData.connectorName || MOCK_DETAIL.connectorName,
        method: rowData.method ?? MOCK_DETAIL.method,
        function: rowData.function ?? MOCK_DETAIL.function,
        time: rowData.time ?? MOCK_DETAIL.time,
    };

    const handleBack = () => navigate(ROUTES.CONNECTOR_LOGS);
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
                <div className="min-w-0">
                    ...
                    >
                        ...
                        Back to Connector logs
                    </button>
                    <h1 className="text-[20px] font-bold text-[#111827] leading-[28px]">Connector log details</h1>
                ...
                <button
                    ...
                    className="h-[36px] px-4 text-[13px] font-medium text-[#0057ff] bg-white border border-[#e5e7eb] rounded-[8px] hover:bg-gray-50 transition-colors self-start shrink-0"
                >
                    Export CSV
                </button>
            </div>
            ...
            <div className="bg-white rounded-[12px] border border-[#e5e7eb] p-4 sm:p-6 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-3">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <InfoRow label="Connector name:">
                            <span className="text-[#0057ff] font-medium">{detail.connectorName}</span>
                        </InfoRow>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <InfoRow label="Request billcode:">
                            {detail.requestBillcode}
                        </InfoRow>
                        <InfoRow label="Response code:">
                            <ResponseCodeBadge code={detail.responseCode} />
                        </InfoRow>
...
export default DetailConnectorLogPage;
