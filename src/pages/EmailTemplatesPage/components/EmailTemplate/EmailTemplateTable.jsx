...
const STATUS_CONFIG = {
    Active: {
        ...
        style: { backgroundColor: '#f0fdf4', borderRadius: '999px', padding: '4px 12px' },
    },
    Draft: {
        label: 'Draft',
        className: 'text-gray-500',
        style: { backgroundColor: '#f3f4f6', borderRadius: '999px', padding: '4px 12px' },
    },
    Inactive: {
        label: 'Inactive',
...
const COLUMNS = [
    ...
    { id: 'subject', label: 'Subject', width: '' },
...
const tdClass = 'px-4 h-[44px] text-[13px] leading-[20px] text-[#1f2937] font-normal border-b border-[#F3F4F6] align-middle';

/* Checkbox — đồng bộ AdministratorTable */
...
/* Status badge — pill style đồng bộ AdministratorTable */
...
/* Edit icon — outline, đồng bộ AdministratorTable */
const EditIcon = () => (
...
/* Delete icon — filled, đồng bộ AdministratorTable */
const DeleteIcon = () => (
...
/* Action button — 24x24, đồng bộ AdministratorTable */
...
/* Truncate subject */
const TruncatedText = ({ text, maxLength = 44 }) => {
    ...
    return (
        <div className="overflow-x-auto">
            <table className="w-full min-w-[760px] border-collapse">
                <thead>
                    {/* Header — màu #f5f8ff đồng bộ AdministratorTable */}
                        ...
                        rows.map((row, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className={tdClass}><TruncatedText text={row.subject} /></td>
