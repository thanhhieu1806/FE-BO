...
const DeleteRoleModal = ({ row, onConfirm, onCancel }) => {
    if (!row) return null;
    ...
    return (
        <>
            ...
            >
                {/* Modal */}
                <div
                    className="bg-white rounded-[16px] w-[400px] p-6 flex flex-col gap-4 shadow-xl"
                ...
                >
                    ...
                    <div className="flex flex-col gap-2">
                        <h2 className="text-[18px] font-bold text-[#111827] leading-[26px]">
                            Delete role{' '}
                            <span className="text-[#0057ff]">{row.roleName}</span>?
                        </h2>
                        <p className="text-[14px] text-[#6b7280] leading-[22px]">
                            This role will be permanently deleted. Administrators assigned to this role may lose their permissions.
                        </p>
                    </div>
