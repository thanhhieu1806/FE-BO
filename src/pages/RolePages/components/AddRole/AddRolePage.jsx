    ...
    return (
        <div className="min-h-full bg-[#f8f9fb] p-4 sm:p-6">
            ...
            <nav className="flex items-center gap-1.5 text-[16px] leading-[24px] mb-4">
                ...
                <span className="font-bold text-[#0057ff]">Add roles & permissions</span>
            </nav>

            {/* Header — wrap trên mobile */}
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
                <div className="min-w-0">
                    <h1 className="text-[20px] font-bold text-[#111827] leading-[28px]">Add Role</h1>
                    <p className="text-[13px] text-[#6b7280] mt-0.5">
                        Create a new role and define its permissions to control platform access.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            placeholder="e.g. Manage administrators and platform configuration"
                            className={inputClass}
                        />
                    </div>
